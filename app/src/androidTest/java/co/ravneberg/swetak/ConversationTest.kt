...
import co.ravneberg.swetak.conversation.ConversationContent
import co.ravneberg.swetak.conversation.ConversationTestTag
import co.ravneberg.swetak.conversation.ConversationUiState
import co.ravneberg.swetak.data.exampleUiState
...
class ConversationTest {
    ...
    fun setUp() {
        ...
        composeTestRule.setContent {
            SweTakTheme(isDarkTheme = themeIsDark.collectAsStateWithLifecycle(false).value) {
                ConversationContent(
